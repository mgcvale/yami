...
public class BackblazeService {
    ...
    public String uploadFile(MultipartFile file, String b2FileName) throws B2Exception, IOException {
    ...
    public MediaType getContentType(String fileName) throws B2Exception {
