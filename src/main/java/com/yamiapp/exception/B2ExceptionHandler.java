...
public class B2ExceptionHandler {
    ...
    @ExceptionHandler(B2BadRequestException.class)
    public void handleB2BadRequest(B2BadRequestException e) {
        logger.info("Pre-handling B2BadRequestException: {}", e.getMessage());
        throw new InternalServerException(ErrorStrings.B2_INTERNAL.getMessage());
    }
